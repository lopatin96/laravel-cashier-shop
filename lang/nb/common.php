...
return [
    ...
    "Shop | :app_name" => "Butikk | :app_name",

    "Shop" => "Butikk",
    "Signed in as" => "Pålogget som",
    "Purchase management for" => "Kjøpsadministrasjon for",
    "sidebar-text" => "Kjøp produkter som fjerner begrensninger og løfter dine evner til et helt nytt nivå.",
    ...
    'product.quantity.more.tooltip' => 'En til',
    'product.quantity.less.tooltip' => 'En mindre',

    'order-history.title' => 'Ordrehistorikk',
    'order-history.product' => 'Produkt',
    'order-history.quantity' => 'Mengde',
    'order-history.date' => 'Dato',

    'buttons.buy.title' => 'Kjøp nå',
