...
return [
    ...
    'Shop | :app_name' => 'Sklep | :app_name',

    'Shop' => 'Sklep',
    'Signed in as' => 'Zalogowany jako',
    'Purchase management for' => 'Zarządzanie zakupami dla',
    'sidebar-text' => 'Kupuj produkty, które usuną ograniczenia i przeniosą Twoje możliwości na zupełnie nowy poziom.',
    'Return to' => 'Wróć do',
    ...
    'product.quantity.more.tooltip' => 'Jeszcze jeden',
    'product.quantity.less.tooltip' => 'Jeden mniej',

    'order-history.title' => 'Historia zamówień',
    'order-history.product' => 'Produkt',
    'order-history.quantity' => 'Ilość',
    'order-history.date' => 'Data',

    'buttons.buy.title' => 'Kup teraz',
