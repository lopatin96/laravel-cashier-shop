...
return [
    ...
    'Shop | :app_name' => 'Tienda | :app_name',

    'Shop' => 'Tienda',
    'Signed in as' => 'Conectado como',
    'Purchase management for' => 'Gestión de compras para',
    'sidebar-text' => 'Compra productos que eliminarán limitaciones y llevarán tus capacidades a un nivel completamente nuevo.',
    ...
    'product.quantity.more.tooltip' => 'Uno más',
    'product.quantity.less.tooltip' => 'Uno menos',

    'order-history.title' => 'Historial de Pedidos',
    'order-history.product' => 'Producto',
    'order-history.quantity' => 'Cantidad',
    'order-history.date' => 'Fecha',

    'buttons.buy.title' => 'Comprar ahora',
