...
return [
    ...
    'Shop | :app_name' => 'Boutique | :app_name',

    'Shop' => 'Boutique',
    'Signed in as' => 'Connecté en tant que',
    'Purchase management for' => 'Gestion des achats pour',
    'sidebar-text' => 'Achetez des produits qui supprimeront les limites et porteront vos capacités à un tout autre niveau.',
    ...
    'product.quantity.more.tooltip' => 'Un de plus',
    'product.quantity.less.tooltip' => 'Un de moins',

    'order-history.title' => 'Historique des Commandes',
    'order-history.product' => 'Produit',
    'order-history.quantity' => 'Quantité',
    'order-history.date' => 'Date',

    'buttons.buy.title' => 'Acheter maintenant',
