...
return [
    ...
    'Shop | :app_name' => 'Winkel | :app_name',

    'Shop' => 'Winkel',
    'Signed in as' => 'Ingelogd als',
    'Purchase management for' => 'Aankoopbeheer voor',
    'sidebar-text' => 'Koop producten die beperkingen verwijderen en je mogelijkheden naar een geheel nieuw niveau tillen.',
    ...
    'product.quantity.more.tooltip' => 'Nog een',
    'product.quantity.less.tooltip' => 'Één minder',

    'order-history.title' => 'Bestelgeschiedenis',
    'order-history.product' => 'Product',
    'order-history.quantity' => 'Hoeveelheid',
    'order-history.date' => 'Datum',

    'buttons.buy.title' => 'Nu kopen',
