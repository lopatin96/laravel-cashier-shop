...
<h2 class="mt-1 text-lg font-semibold text-gray-700">
    {{ __('laravel-cashier-shop::common.Shop') }}
</h2>
<div class="flex items-center mt-12 text-gray-600">
    <div>
        {{ __('laravel-cashier-shop::common.Signed in as') }}
    </div>
...
<div class="mt-3 text-sm text-gray-600">
    {{ __('laravel-cashier-shop::common.Purchase management for') }} {{ auth()->user()->name }}.
</div>
<div class="mt-12 text-gray-600">
    {{ __('laravel-cashier-shop::common.sidebar-text', ['app_name' => config('app.name')]) }}
</div>
<div class="mt-12">
    <a href="/dashboard" class="flex items-center">
        ...
        <div class="ml-2 text-gray-600 underline">
            {{ __('laravel-cashier-shop::common.Return to') }} {{ config('app.name') }}
        </div>
    </a>
</div>
